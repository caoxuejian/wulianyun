...
//		);
	...
	private void deleteCamera() {
		new AlertDialog.Builder(this).setIcon(android.R.drawable.ic_dialog_alert).setTitle(getText(R.string.tips_title_warning)).setMessage(getText(R.string.tips_msg_delete_camera)).setPositiveButton(getText(R.string.btn_yes), new DialogInterface.OnClickListener() {
			@Override
