...
import com.thecamhi.server.DownloadInBackgroundService;
...
public class VideoOnlineActivity extends HiActivity implements ICameraIOSessionCallback,OnItemClickListener ,ICameraDownloadCallback{
	...
	private void StartBgService(){
		...
		backgroundFile_list.clear();
		backgroundFile_list=file_list;

		Intent intent=new Intent(VideoOnlineActivity.this,DownloadInBackgroundService.class);
		Bundle bundle=new Bundle();
	...
	private void downloadRecording(int position) {
		...
		if(HiTools.isSDCardValid()){
			...
			File rootFolder = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/"+getString(R.string.app_name) + "/");
