...
public class MailboxSettingActivity extends HiActivity implements ICameraIOSessionCallback {
		...
		title.setNavigationBarButtonListener(new NavigationBarButtonListener() {
			...
			public void OnNavigationButtonClick(int which) {
				...
				case TitleView.NAVIGATION_BUTTON_LEFT:
					MailboxSettingActivity.this.finish();
					break;
			...
			case HiDataValue.HANDLE_MESSAGE_RECEIVE_IOCTRL:
			{
				if(msg.arg2==0) {
					...
					case HiChipDefines.HI_P2P_SET_EMAIL_PARAM_EXT:
						if(!isCheck){
						HiToast.showToast(MailboxSettingActivity.this, 
