...
public class AliveSettingActivity extends HiActivity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		break;
		case R.id.alarm_motion_detection://报警移动侦测
		{
		...
		break;
		case R.id.action_with_alarm://报警联动
		{
		...
		break;
		case R.id.wifi_settings://wifi设置
		{
		...
		break;
		case R.id.equipment_time_setting://设备时间设置
		{
			Intent intent=new Intent(AliveSettingActivity.this,EquipmentTimeSettingActivity.class);
			intent.putExtra(HiDataValue.EXTRAS_KEY_UID, mCamera.getUid());
			startActivity(intent);
		}

		break;
		case R.id.mailbox_settings://邮箱设置
		{
			Intent intent=new Intent(AliveSettingActivity.this,MailboxSettingActivity.class);
			intent.putExtra(HiDataValue.EXTRAS_KEY_UID, mCamera.getUid());
			startActivity(intent);
		}
		break;
		case R.id.ftp_settings://ftp设置
		{
		...
		break;
		case R.id.equipment_information://设备信息
		{
