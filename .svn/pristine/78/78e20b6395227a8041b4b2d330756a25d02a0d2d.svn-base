...
public class EquipmentTimeSettingActivity extends HiActivity implements ICameraIOSessionCallback,OnClickListener{
		...
		title.setNavigationBarButtonListener(new NavigationBarButtonListener() {
			...
			public void OnNavigationButtonClick(int which) {
				...
				case TitleView.NAVIGATION_BUTTON_LEFT:
					EquipmentTimeSettingActivity.this.finish();
					break;
				}
			...
			case HiDataValue.HANDLE_MESSAGE_RECEIVE_IOCTRL:
			{
				if(msg.arg2==0) {
					...
					case HiChipDefines.HI_P2P_SET_TIME_PARAM:
						...
						HiToast.showToast(EquipmentTimeSettingActivity.this, getString(R.string.tips_device_time_setting_synchroned_time));

						break;
					case HiChipDefines.HI_P2P_SET_TIME_ZONE:
						
						HiToast.showToast(EquipmentTimeSettingActivity.this, getString(R.string.tips_device_time_setting_timezone));
	...
	public void showAlertDialog(){
		AlertDialog.Builder builder=new AlertDialog.Builder(EquipmentTimeSettingActivity.this);
		
		builder.setTitle(getString(R.string.tips_title_warning));
