...
public class SDCardSettingActivity extends HiActivity implements ICameraIOSessionCallback{
	...
	private EditText available_space_size,storage_space_size;
	...
	private void initView() {
		...
		available_space_size=(EditText)findViewById(R.id.available_space_size);
		storage_space_size=(EditText)findViewById(R.id.storage_space_size);
